 ...
 */
add_filter('bp_tools_facilities_get_item_name', 'wp_filter_kses', 1);


/* Used before storing the data of an tool_facility to be created , in the DB*/
add_filter('bp_tools_facilities_data_before_save', 'wp_filter_kses', 1);
?>