...
/**
 * bp_tools_facilities_record_activity()
 *
 ...
 *
 *   bp_tools_facilities_record_activity( array( 'type' => 'new_highfive', 'action' => 'Andy high-fived John', 'user_id' => $bp->loggedin_user->id, 'item_id' => $bp->displayed_user->id ) );
 *
 */
function bp_tools_facilities_record_activity( $args = '' ) {
	global $bp;
	...
	$defaults = array(
		...
		'content' => '',
		'primary_link' => '',
		'component' => $bp->tools_facilities->id,
		'type' => false,
		'item_id' => false,
