...
/**
 * bp_patents_licenses_record_activity()
 *
 ...
 *
 *   bp_patents_licenses_record_activity( array( 'type' => 'new_highfive', 'action' => 'Andy high-fived John', 'user_id' => $bp->loggedin_user->id, 'item_id' => $bp->displayed_user->id ) );
 *
 */
function bp_patents_licenses_record_activity( $args = '' ) {
	global $bp;
	...
	$defaults = array(
		...
		'content' => '',
		'primary_link' => '',
		'component' => $bp->patents_licenses->id,
		'type' => false,
		'item_id' => false,
