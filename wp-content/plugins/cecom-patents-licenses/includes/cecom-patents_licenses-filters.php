 ...
 */
add_filter('bp_patents_licenses_get_item_name', 'wp_filter_kses', 1);


/* Used before storing the data of an patent_license to be created , in the DB*/
add_filter('bp_patents_licenses_data_before_save', 'wp_filter_kses', 1);
?>