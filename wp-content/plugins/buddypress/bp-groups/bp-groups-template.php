...
function bp_directory_groups_search_form() {
    ...
    $search_form_html = '<form action="" method="get" id="search-groups-form">
			...
			<label style="margin-right:120px; margin-top:30px;">Description keywords
 			<input style="width:300px;" type="text" name="s" id="groups_search" placeholder="' . esc_attr($search_value) . '" /></label>
			 <input type="submit" style="width:500px; height:80px; margin-right:30px; margin-left:100px;" 
