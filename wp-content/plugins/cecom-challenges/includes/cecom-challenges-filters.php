 ...
 */
add_filter('bp_challenges_get_item_name', 'wp_filter_kses', 1);


/* Used before storing the data of an challenge to be created , in the DB*/
add_filter('bp_challenges_data_before_save', 'wp_filter_kses', 1);
?>