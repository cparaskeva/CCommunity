...
<?php if ('request-details' == bp_get_current_signup_step()) : ?>
                            ...
                            <h2>  <img src="<?php bloginfo('stylesheet_directory'); ?>/assets/img/step1.jpg" height="60" width="60">        
                            <?php _e('Create an Account', 'firmasite'); ?></h2>
...
<!--   <div class="panel-body"><h1> This is a temp!</h1></div> -->
<?php
include("/home/demonas/IDEs_Projects/NetBeansProjects/CCommunity/wp-content/themes/firmasite-child/registration/organization.php" );
?>
