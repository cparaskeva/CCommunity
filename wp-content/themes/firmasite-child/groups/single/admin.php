...
<form action="<?php bp_group_admin_form_action(); ?>" name="group-settings-form" id="group-settings-form" class="standard-form" method="post" enctype="multipart/form-data" role="main">
    ...
    <?php if (bp_is_group_admin_screen('edit-details')) : ?>
        ...
        <div>
            ...
            <input type="text" class="form-control" name="organization_specialties" id="organization_specialties" value="<?php echo $cecom->organization->details['specialties'] ?>" aria-required="false"/>
            <br/>
            <label for="organization_website"><?php _e('Organisation Website', 'firmasite'); ?> </label>
            <input type="text" class="form-control" name="organization_website" id="organization_specialties" value="<?php echo $cecom->organization->details['website'] ?>" aria-required="false"/>
            <br/>
        </div>
