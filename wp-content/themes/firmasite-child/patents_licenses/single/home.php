...
<div id="primary" class="content-area <?php echo $firmasite_settings["layout_primary_class"]; ?>">
    <div class="padder">
        ...
        <div id="item-header" class="well well-sm media clearfix" role="complementary">
            ...
            <?php locate_template(array('patents_licenses/single/patent_license-header.php'), true); ?>
        ...
        <div id="item-body">
            ...
            if (bp_is_patent_license_admin_page() && bp_is_item_admin()) :
                locate_template(array('patents_licenses/single/admin.php'), true);
